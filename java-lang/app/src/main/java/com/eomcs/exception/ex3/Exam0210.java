...
public class Exam0210 {
  ...
  //    => JVM에서 발생된 오류이다.
  //    => 개발자가 사용하는 클래스가 아니다.
  //    => 이 오류가 발생하면 현재의 시스템 상태를 즉시 백업(ppt가 강제종료되기 전에 어딘가에 임시 파일로 저장해놓는 것처럼)하고, 실행을 멈춰야 한다.
  ...
  // => 메서드 호출자에게 알려주는 것이다.
  static void m1() throws Throwable { // throws Throwable 지워봐!
    throw new Throwable(); // OK!
    // But.. 예외를 던질 때 Throwable 클래스를 직접 사용하지 말라!
    // 그 하위 클래스를 사용하라.
