...
public class Exam0162 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(classInfo.getName()); //[Ljava.lang.String; : ;세미콜론으로 끝난다.

    // 배열 항목의 타입 정보를 가져온다.
    Class compTypeInfo = classInfo.getComponentType(); // 이 메서드를 호출하면 배열의 한 항목의 클래스 정보를 리턴한다.
