...
public class Exam0130 {
  public static void main(String[] args) {
    ...
    // z = x + y; // 컴파일 오류! 변수에 들어있는 경우는 예외! cannot convert from int to byte
    //
    // "자바의 정수 연산은 최소 단위가 4바이트이다."               //1바이트, 2바이트는 없다
    ...
    s3 = s2; // OK!
    //    s3 = s1 + s2; // 컴파일 오류!
    // 네이버 시험 문제였음!!!! 다음 코드의 실행결과를 쓰시오. 11이 아니라 error다!!! 자바의 기본 연산은 int이니
    // 이렇게 기본이 중요하다!!!! 왜 에러가 뜨는지 정도는 알아야지....이런거 다 손으로 시험 봄!
