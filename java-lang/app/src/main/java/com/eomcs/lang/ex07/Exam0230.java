...
public class Exam0230 {
  ...
  //    => "손들어. 돈내놔!" // 아무것도 없으면서 돈 내놓으락 하는거임
  static String hello() {  //리턴값이 숫자이면 int, 배열이면 array
    // 값을 리턴하는 문법
    // return 값;
