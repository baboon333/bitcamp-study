...
//
// 1) 명령문 블록을 실행할 때 값을 받지 않고 결과도 리턴하지 않는다.  //그래도 ()는 꼭 써야 한다.  //한상은씨 밥 먹고 오세요~
// void 메서드명() {
//   문장1;
//   문장2;
// }
//
// 2) 명령문 블록을 실행할 때 작업에 필요한 값을 받는다. 그러나 결과는 리턴하지 않는다. // 매니저님이 우리에게 취업자료 주며 여기 지원해보세요~
// void 메서드명(변수선언1, 변수선언2, ...) {
//   문장1;
//   문장2;
// }
//
// 3) 명령문 블록을 실행할 때 값을 받지 않는다. 작업 결과는 리턴한다.  //한상은씨 보드마카 갖다 주세요
// 리턴타입 메서드명() {
//   문장1;
//   문장2;
// }
//
// 4) 명령문 블록을 실행할 때 값을 받는다. 그리고 작업 결과를 받는다.
