...
public class Exam0230 {
  ...
  //
  static class Box<T> { // 박스 객체의 타입은 아직 결정된게 아니다. main 메서드에서 박스 인스턴스를 만들 때 결정된다!
  ...
  public static void main(String[] args) {
    ...
    Box<Member> b1 = new Box<Member>(); // 박스는 멤버를 담는다.
    ...
    // - 제네릭에서 지정한 타입이 아닌 경우 컴파일 오류! 박스에 담을 타입을 통제함
