...
// stateful 방식
// => 서버와 연결한 후, 
//    클라이언트에서 연결을 끊을 때까지 (또는 서버에서 연결을 끊을 때까지 -> 보통 클라이언트가 끊는다.)
...
//    - 채팅 서버: 전용 클라이언트를 이용한 채팅. 예) 유튜브 라이브 방송 채팅 -> 메신저의 경우는 상대쪽 컴퓨터가 꺼져있어도 데이터가 가지만 이건 상대편과 내 컴퓨터 모두 켜져있어야 한다!
//    - 텔렛: 원격 제어 프로그램 -> 아마존 EC2 리눅스 서버 연결했던 것!
//    - FTP: 파일 전송 프로그램
//    - 오프라인 예: 건강보험문의, 상담 등 
//
// => 통신
