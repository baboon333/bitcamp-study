...
public class Exam0150 {
  ...
  public static void main(String[] args) {
    ...
    Calculator c1 = (a, b) -> { // int a, int b 파라미터 타입 생략 가능
      return a + b;
    };
