...
public class Exam0230 {
  ...
  public static void main(String[] args) {
    ...
    System.out.printf("result = %d\n", Calculator.result);  //0220과는 다르게 result가 calculator 안에 있으니 Calculator.result !!
  }
}
