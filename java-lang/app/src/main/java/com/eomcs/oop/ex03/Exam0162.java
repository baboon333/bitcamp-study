...
public class Exam0162 {
  ...
  static class Member {  //nested class(중첩 클래스)
    ...
    public static final int GUEST = 0;  // 0161에서는 로컬 변수로 잡았었음
    public static final int MEMBER = 1;  // 보통 상수 변수는 public static final이다!
    public static final int MANAGER = 2;

    String id;  // 각 인스턴스마다 개별 데이터로 관리해야 한다면 이렇게 non-static 변수로!
    String password;
