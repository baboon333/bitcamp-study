...
public class Exam0310 {
  public static void main(String[] args) {
    ...
    s1.name = "홍길동";  //s1의 name 혹은 s1 객체의 name 이런식으로 개발자들 다 줄여말함~ // "홍길동"은 String 이기 때문에(자바 원시타입이 아닌 레퍼런스 변수이다) 사실은 이 자리에 주소가 오는 건데 헷갈리니까 그냥 그림 그릴 때는 String까지는 그냥 값이 들어간다고 생각하고 그리시는 거임 
