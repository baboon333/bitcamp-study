...
public class Exam0220 {
  public static void main(String[] args) throws Exception {
    ...
    // 가능한 개발 중에 사용하지 말라!
    Integer obj1 = new Integer(100); // int하고 다름!
    ...
    Integer i2 = Integer.valueOf(200);  // 이렇게 하면 i1에 인티저 객체를 리턴한다.
    ...
    int v1 = i2.intValue(); // integer 객체에서 int 값을 뽑아낼 때 쓰는 인스턴스 메서드
    System.out.println(v1);

    // 스태틱 메서드 = 클래스 메서드 사용
    int v2 = Integer.parseInt("1280");     // String => int 변환
    String s1 = Integer.toBinaryString(77);  // 10진수를 이진수 문자열로
    String s2 = Integer.toOctalString(77);  // 8진수 문자열로
    String s3 = Integer.toHexString(77); // 16진수 문자열로
    ...
    float f = Float.parseFloat("3.14f");  // 스태틱 메서드. 그냥 파라미터로 작업하는!
