...
public class Exam0220 {
  public static void main(String[] args) {
    ...
    // => 없다!  (c++은 만들 수 있다. 자바는 인스턴스 배열을 만드는 방법이 없다. 무조건 new를 이용해서 한번에 한개씩 만들 수 있다.)
    ...
    arr[0] = new Score();  // score 설계도에 따라 heap 메모리에 만들고 그 주소를 arr가 가리키는 주소로 가서 0번 방에다 이를 넣어라!!
    arr[1] = new Score();
    arr[2] = new Score();
...
//   해당 타입의 메모리를 배열로 만들 수 있다.  // int 배열은 그냥 int가 여러개 만들어질 수 있잖아
