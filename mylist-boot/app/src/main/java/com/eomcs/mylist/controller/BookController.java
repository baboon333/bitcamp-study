...
public class BookController {
  ...
  public BookController() throws Exception {
    ...
    DataInputStream in = new DataInputStream(new BufferedInputStream(new FileInputStream("books.data"))); // 주 객체에 데코레이터 객체를 연결 // 실무에서는 이렇게 안에다 바로 써준다
  ...
  public Object save() throws Exception {
    DataOutputStream out = new DataOutputStream(new BufferedOutputStream(new FileOutputStream("books.data"))); // 따로 경로를 지정하지 않으면 파일은 프로젝트 폴더에 생성된다.
